                            ...
                            <label className='dropzone' htmlFor='resume'>
                                {resumeFile ? (
                                    <>
                                        ...
                                        <p className='dropzone__title' style={{ color: '#22c55e', fontWeight: 600 }}>{resumeFile.name}</p>
                                        <p className='dropzone__subtitle'>
                                            ...
                                            <span 
                                                ...
                                                style={{ marginLeft: '10px', color: '#ff2d78', cursor: 'pointer', textDecoration: 'underline' }}
                                            >
                                                Remove
                                            </span>
                                        </p>
